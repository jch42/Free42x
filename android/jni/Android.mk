...
LOCAL_MODULE    := free42
LOCAL_SRC_FILES := free42glue.cc core_commands1.cc core_commands2.cc core_commands3.cc core_commands4.cc core_commands5.cc core_commands6.cc core_commands7.cc core_commands8.cc core_display.cc core_globals.cc core_helpers.cc core_keydown.cc core_linalg1.cc core_linalg2.cc core_main.cc core_math1.cc core_math2.cc core_phloat.cc core_sto_rcl.cc core_tables.cc core_variables.cc hpil_common.cc hpil_controller.cc hpil_core.cc hpil_extended.cc hpil_mass.cc hpil_plotter.cc hpil_printer.cc shell_spool.cc log2.cc
