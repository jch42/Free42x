...
static const command_spec cmd_array[] =
{
    ...
    { /* SILENT_OFF */  "",                     0, NULL,              0xf2000000, ARG_NONE,  FLAG_HIDDEN + FLAG_NO_SHOW },
    { /* SILENT_ON */   "",                     0, NULL,              0xf2000000, ARG_NONE,  FLAG_HIDDEN + FLAG_NO_SHOW },
    ...
    { /* STO */         "STO",                  3, docmd_sto,         0x11810091, ARG_VAR,   FLAG_NONE },
    ...
    { /* RCL */         "RCL",                  3, docmd_rcl,         0x21910090, ARG_VAR,   FLAG_NONE },
    ...
    { /* FIX */         "FIX",                  3, docmd_fix,         0x31d4009c, ARG_NUM11, FLAG_NONE },
    { /* SCI */         "SCI",                  3, docmd_sci,         0x31d5009d, ARG_NUM11, FLAG_NONE },
    { /* ENG */         "ENG",                  3, docmd_eng,         0x31d6009e, ARG_NUM11, FLAG_NONE },
    { /* ALL */         "ALL",                  3, docmd_all,         0x0000a25d, ARG_NONE,  FLAG_NONE },
    { /* NULL */        "\316\325\314\314",     4, docmd_null,        0xf2000000, ARG_NONE,  FLAG_HIDDEN },
    ...
    { /* SIZE */        "SIZE",                 4, docmd_size,        0x41000000, ARG_COUNT, FLAG_NONE },
    { /* QUIET */       "QUIET",                5, docmd_quiet,       0xf2000000, ARG_NONE,  FLAG_IMMED },
    ...
    { /* DEL */         "DEL",                  3, docmd_del,         0xf2000000, ARG_COUNT, FLAG_PRGM_ONLY + FLAG_IMMED },
    ...
    { /* CLALLa */      "CLALL",                5, NULL,              0xf2000000, ARG_NONE,  FLAG_IMMED },
    ...
    { /* LBL */         "LBL",                  3, docmd_lbl,         0x510000cf, ARG_OTHER, FLAG_PRGM_ONLY },
    { /* RTN */         "RTN",                  3, docmd_rtn,         0x00000085, ARG_NONE,  FLAG_NONE },
    { /* INPUT */       "INPUT",                5, docmd_input,       0x61c5f2d0, ARG_VAR,   FLAG_PRGM_ONLY },
    { /* VIEW */        "VIEW",                 4, docmd_view,        0x00800098, ARG_VAR,   FLAG_NONE },
    { /* AVIEW */       "AVIEW",                5, docmd_aview,       0x0000007e, ARG_NONE,  FLAG_NONE },
    { /* XEQ */         "XEQ",                  3, docmd_xeq,         0x71a700ae, ARG_LBL,   FLAG_NONE },
    ...
    { /* KEYG */        "KEYG",                 4, NULL,              0xf2000000, ARG_MKEY,  FLAG_NONE },
    { /* KEYX */        "KEYX",                 4, NULL,              0xf2000000, ARG_MKEY,  FLAG_NONE },
    ...
    { /* PRP */         "PRP",                  3, docmd_prp,         0xf2000000, ARG_PRGM,  FLAG_IMMED },
    ...
    { /* LIST */        "LIST",                 4, docmd_list,        0xf2000000, ARG_COUNT, FLAG_IMMED },
    ...
    { /* GTO */         "GTO",                  3, docmd_gto,         0x81a60000, ARG_LBL,   FLAG_NONE },
    { /* END */         "END",                  3, docmd_end,         0x91000000, ARG_NONE,  FLAG_NONE },
    { /* NUMBER */      "",                     0, docmd_number,      0xa1000000, ARG_NONE,  FLAG_HIDDEN },
    { /* STRING */      "",                     0, docmd_string,      0xb1000000, ARG_NONE,  FLAG_HIDDEN },
    { /* RUN */         "RUN",                  3, NULL,              0xf2000000, ARG_NONE,  FLAG_HIDDEN },
    { /* SST */         "SST",                  3, NULL,              0xf2000000, ARG_NONE,  FLAG_NONE },
    { /* GTODOT */      "GTO .",                5, docmd_gtodot,      0xf2000000, ARG_OTHER, FLAG_IMMED },
    { /* GTODOTDOT */   "GTO ..",               6, docmd_gtodotdot,   0xf2000000, ARG_NONE,  FLAG_IMMED },
    ...
    { /* ASSIGNa */     "AS\323\311GN",         6, NULL,              0xf2000000, ARG_NAMED, FLAG_NONE },
    { /* ASSIGNb */     "",                     0, NULL,              0xf2000000, ARG_CKEY,  FLAG_HIDDEN },
    { /* ASGN01 */      "",                     0, docmd_asgn01,      0xc1000000, ARG_OTHER, FLAG_HIDDEN },
    { /* ASGN02 */      "",                     0, docmd_asgn02,      0xc1000001, ARG_OTHER, FLAG_HIDDEN },
    { /* ASGN03 */      "",                     0, docmd_asgn03,      0xc1000002, ARG_OTHER, FLAG_HIDDEN },
    { /* ASGN04 */      "",                     0, docmd_asgn04,      0xc1000003, ARG_OTHER, FLAG_HIDDEN },
    { /* ASGN05 */      "",                     0, docmd_asgn05,      0xc1000004, ARG_OTHER, FLAG_HIDDEN },
    { /* ASGN06 */      "",                     0, docmd_asgn06,      0xc1000005, ARG_OTHER, FLAG_HIDDEN },
    { /* ASGN07 */      "",                     0, docmd_asgn07,      0xc1000006, ARG_OTHER, FLAG_HIDDEN },
    { /* ASGN08 */      "",                     0, docmd_asgn08,      0xc1000007, ARG_OTHER, FLAG_HIDDEN },
    { /* ASGN09 */      "",                     0, docmd_asgn09,      0xc1000008, ARG_OTHER, FLAG_HIDDEN },
    { /* ASGN10 */      "",                     0, docmd_asgn10,      0xc1000009, ARG_OTHER, FLAG_HIDDEN },
    { /* ASGN11 */      "",                     0, docmd_asgn11,      0xc100000a, ARG_OTHER, FLAG_HIDDEN },
    { /* ASGN12 */      "",                     0, docmd_asgn12,      0xc100000b, ARG_OTHER, FLAG_HIDDEN },
    { /* ASGN13 */      "",                     0, docmd_asgn13,      0xc100000c, ARG_OTHER, FLAG_HIDDEN },
    { /* ASGN14 */      "",                     0, docmd_asgn14,      0xc100000d, ARG_OTHER, FLAG_HIDDEN },
    { /* ASGN15 */      "",                     0, docmd_asgn15,      0xc100000e, ARG_OTHER, FLAG_HIDDEN },
    { /* ASGN16 */      "",                     0, docmd_asgn16,      0xc100000f, ARG_OTHER, FLAG_HIDDEN },
    { /* ASGN17 */      "",                     0, docmd_asgn17,      0xc1000010, ARG_OTHER, FLAG_HIDDEN },
    { /* ASGN18 */      "",                     0, docmd_asgn18,      0xc1000011, ARG_OTHER, FLAG_HIDDEN },
    { /* ON */          "ON",                   2, docmd_on,          0x0000a270, ARG_NONE,  FLAG_NONE },
    { /* OFF */         "OFF",                  3, docmd_off,         0x0000008d, ARG_NONE,  FLAG_NONE },
    { /* KEY1G */       "KEY 1 GTO",            9, docmd_key1g,       0xd1c301, ARG_LBL,   FLAG_HIDDEN },
    { /* KEY2G */       "KEY 2 GTO",            9, docmd_key2g,       0xd1c30002, ARG_LBL,   FLAG_HIDDEN },
    { /* KEY3G */       "KEY 3 GTO",            9, docmd_key3g,       0xd1c30003, ARG_LBL,   FLAG_HIDDEN },
    { /* KEY4G */       "KEY 4 GTO",            9, docmd_key4g,       0xd1c30004, ARG_LBL,   FLAG_HIDDEN },
    { /* KEY5G */       "KEY 5 GTO",            9, docmd_key5g,       0xd1c30005, ARG_LBL,   FLAG_HIDDEN },
    { /* KEY6G */       "KEY 6 GTO",            9, docmd_key6g,       0xd1c30006, ARG_LBL,   FLAG_HIDDEN },
    { /* KEY7G */       "KEY 7 GTO",            9, docmd_key7g,       0xd1c30007, ARG_LBL,   FLAG_HIDDEN },
    { /* KEY8G */       "KEY 8 GTO",            9, docmd_key8g,       0xd1c30008, ARG_LBL,   FLAG_HIDDEN },
    { /* KEY9G */       "KEY 9 GTO",            9, docmd_key9g,       0xd1c30009, ARG_LBL,   FLAG_HIDDEN },
    { /* KEY1X */       "KEY 1 XEQ",            9, docmd_key1x,       0xd1c20001, ARG_LBL,   FLAG_HIDDEN },
    { /* KEY2X */       "KEY 2 XEQ",            9, docmd_key2x,       0xd1c20002, ARG_LBL,   FLAG_HIDDEN },
    { /* KEY3X */       "KEY 3 XEQ",            9, docmd_key3x,       0xd1c20003, ARG_LBL,   FLAG_HIDDEN },
    { /* KEY4X */       "KEY 4 XEQ",            9, docmd_key4x,       0xd1c20004, ARG_LBL,   FLAG_HIDDEN },
    { /* KEY5X */       "KEY 5 XEQ",            9, docmd_key5x,       0xd1c20005, ARG_LBL,   FLAG_HIDDEN },
    { /* KEY6X */       "KEY 6 XEQ",            9, docmd_key6x,       0xd1c20006, ARG_LBL,   FLAG_HIDDEN },
    { /* KEY7X */       "KEY 7 XEQ",            9, docmd_key7x,       0xd1c20007, ARG_LBL,   FLAG_HIDDEN },
    { /* KEY8X */       "KEY 8 XEQ",            9, docmd_key8x,       0xd1c20008, ARG_LBL,   FLAG_HIDDEN },
    { /* KEY9X */       "KEY 9 XEQ",            9, docmd_key9x,       0xd1c20009, ARG_LBL,   FLAG_HIDDEN },
    { /* VMEXEC */      "",                     0, NULL,              0xf2000000, ARG_OTHER, FLAG_HIDDEN },
    { /* VMSTO */       "STO",                  3, docmd_vmsto,       0xf2000000, ARG_OTHER, FLAG_HIDDEN },
    ...
    { /* SIMQ */        "SIMQ",                 4, docmd_simq,        0xf2000000, ARG_COUNT, FLAG_HIDDEN + FLAG_NO_PRGM },
    { /* MATA */        "MATA",                 4, docmd_mata,        0xf2000000, ARG_NONE,  FLAG_HIDDEN + FLAG_NO_PRGM },
    { /* MATB */        "MATB",                 4, docmd_matb,        0xf2000000, ARG_NONE,  FLAG_HIDDEN + FLAG_NO_PRGM },
    { /* MATX */        "MATX",                 4, docmd_matx,        0xf2000000, ARG_NONE,  FLAG_HIDDEN + FLAG_NO_PRGM },
    { /* GOTOROW */     "GOTO\240\322\357\367", 8, NULL,              0xf2000000, ARG_COUNT, FLAG_HIDDEN },
    { /* GOTOCOLUMN */  "GOTO Column",         11, NULL,              0xf2000000, ARG_COUNT, FLAG_HIDDEN },
    { /* A_THRU_F */    "A...F",                5, NULL,              0xf2000000, ARG_NONE,  FLAG_HIDDEN + FLAG_NO_PRGM },
    { /* CLALLb */      "CLALL",                5, docmd_clall,       0xf2000000, ARG_NONE,  FLAG_HIDDEN },
    { /* PGMSLVi */     "P\307\315SLV",         6, docmd_pgmslvi,     0xf2000000, ARG_PRGM,  FLAG_HIDDEN },
    { /* PGMINTi */     "P\307\315INT",         6, docmd_pgminti,     0xf2000000, ARG_PRGM,  FLAG_HIDDEN },
    { /* VMSTO2 */      "STO",                  3, docmd_vmsto2,      0xf2000000, ARG_OTHER, FLAG_HIDDEN },
    { /* VMSOLVE */     "SOLVE",                5, docmd_vmsolve,     0xf2000000, ARG_OTHER, FLAG_HIDDEN },
	...
	/* hpil expansion */
    { /* IFC */         "IFC",					3, docmd_ifc,         0x0000a597, ARG_NONE,  FLAG_NONE },
    { /* NLOOP */       "NLO\317P",				5, docmd_nloop,       0x0000a5e1, ARG_NONE,  FLAG_NONE },
    { /* SELECT */      "S\305L\305CT",			6, docmd_select,      0x0000a727, ARG_NONE,  FLAG_NONE },
    { /* RCLSEL */      "RCLS\305L",			6, docmd_rclsel,      0x0000a5ed, ARG_NONE,  FLAG_NONE },
	{ /* PRTSEL */		"PRTS\305L",			6, docmd_prtsel,	  0X0000a6d9, ARG_NONE,  FLAG_NONE },
	{ /* DSKSEL */		"DSKS\305L",			6, docmd_dsksel,	  0X0000a6da, ARG_NONE,  FLAG_NONE },
	{ /* AUTOIO */		"AUTOI\317",			6, docmd_autoio,	  0X0000a71b, ARG_NONE,  FLAG_NONE },
	{ /* MANIO */		"MANI\317",				5, docmd_manio,		  0X0000a722, ARG_NONE,  FLAG_NONE },
	...
	{ /* UNSEC */		"UNSEC",				5, docmd_unsec,		  0x0000a70f, ARG_NONE,  FLAG_NONE },
	{ /* WRTP */		"WRTP",					4, docmd_wrtp,		  0x0000a713, ARG_NONE,  FLAG_NONE },
	{ /* WRTR */		"WRTR",					4, docmd_wrtr,		  0x0000a715, ARG_NONE,  FLAG_NONE },
	{ /* ZERO */		"ZERO",					4, docmd_zero,		  0x0000a718, ARG_NONE,  FLAG_NONE },
    ...
    { /* INAN */        "IN\301N",				4, docmd_inan,        0x0000a5dd, ARG_NONE,  FLAG_NONE },
    { /* INXB */        "INXB",				    4, docmd_inxb,        0x0000a5de, ARG_NONE,  FLAG_NONE },
    { /* INACCL */      "IN\301CCL",			6, docmd_inaccl,      0x0000a5df, ARG_NONE,  FLAG_NONE },
    { /* OUTAC */       "OUT\301C",				5, docmd_outac,       0x0000a5e3, ARG_NONE,  FLAG_NONE },
    ...
    { /* CSIZE */       "CSIZE",				5, docmd_xrom,        0x0000a442, ARG_NONE,  FLAG_HIDDEN },
    { /* CSIZEO */      "CSIZEO",				6, docmd_xrom,        0x0000a443, ARG_NONE,  FLAG_HIDDEN },
    { /* DGTIZE */      "DGTIZE",				6, docmd_xrom,        0x0000a444, ARG_NONE,  FLAG_HIDDEN },
    { /* DRAW */      	"DRAW",					4, docmd_draw,        0x0000a445, ARG_NONE,  FLAG_NONE },
    { /* FRAME */       "FRAME",				5, docmd_xrom,        0x0000a446, ARG_NONE,  FLAG_HIDDEN },
    { /* GCLEAR */      "GCLEAR",				6, docmd_xrom,        0x0000a447, ARG_NONE,  FLAG_HIDDEN },
    { /* IDRAW */      	"IDRAW",				5, docmd_idraw,       0x0000a448, ARG_NONE,  FLAG_NONE },
    { /* IMOVE */      	"IMOVE",				5, docmd_imove,       0x0000a449, ARG_NONE,  FLAG_NONE },
    { /* IPLOT */      	"IPLOT",				5, docmd_iplot,       0x0000a44a, ARG_NONE,  FLAG_NONE },
    { /* LABEL */       "LABEL",				5, docmd_xrom,        0x0000a44b, ARG_NONE,  FLAG_HIDDEN },
    { /* LDIR */      	"LDIR",					4, docmd_xrom,        0x0000a44b, ARG_NONE,  FLAG_HIDDEN },
    ...
    { /* LXAXIS */      "LXAXIS",				6, docmd_xrom,        0x0000a453, ARG_NONE,  FLAG_HIDDEN },
    { /* LYAXIS */      "LYAXIS",				6, docmd_xrom,        0x0000a454, ARG_NONE,  FLAG_HIDDEN },
    { /* MOVE */      	"MOVE",					4, docmd_move,        0x0000a455, ARG_NONE,  FLAG_NONE },
    ...
    { /* PLOT */      	"PLOT",					4, docmd_plot,        0x0000a45a, ARG_NONE,  FLAG_NONE },
    { /* PLREGX */      "PLREGX",			    6, docmd_plregx,      0x0000a45b, ARG_NONE,  FLAG_NONE },
    { /* RATIO */       "RATIO",			    5, docmd_ratio,       0x0000a45c, ARG_NONE,  FLAG_NONE },
    { /* RPLOT */      	"RPLOT",				5, docmd_rplot,       0x0000a45d, ARG_NONE,  FLAG_NONE },
    { /* SCALE */       "SCALE",			    5, docmd_scale,       0x0000a45e, ARG_NONE,  FLAG_NONE },
    { /* SETGU */      	"SETGU",				5, docmd_xrom,        0x0000a45f, ARG_NONE,  FLAG_HIDDEN },
    { /* SETUU */      	"SETUU",				5, docmd_xrom,        0x0000a460, ARG_NONE,  FLAG_HIDDEN },
    { /* TICLEN */      "TICLEN",				6, docmd_xrom,        0x0000a461, ARG_NONE,  FLAG_HIDDEN },
    { /* UNCLIP */      "UNCLIP",				6, docmd_xrom,        0x0000a462, ARG_NONE,  FLAG_HIDDEN },
    { /* WHERE */      	"WHERE",				5, docmd_xrom,        0x0000a463, ARG_NONE,  FLAG_HIDDEN },
    { /* XAXIS */      	"XAXIS",				5, docmd_xrom,        0x0000a464, ARG_NONE,  FLAG_HIDDEN },
    { /* XAXISO */      "XAXISO",				6, docmd_xrom,        0x0000a465, ARG_NONE,  FLAG_HIDDEN },
    { /* YAXIS */      	"YAXIS",				5, docmd_xrom,        0x0000a466, ARG_NONE,  FLAG_HIDDEN },
    { /* YAXISO */      "YAXISO",				6, docmd_xrom,        0x0000a467, ARG_NONE,  FLAG_HIDDEN },
    { /* PCLBUF */      "PCLBUF",				6, docmd_pclbuf,      0x0000a481, ARG_NONE,  FLAG_NONE },
    { /* PDIR */      	"PDIR",				    4, docmd_pdir,        0x0000a482, ARG_NONE,  FLAG_NONE },
