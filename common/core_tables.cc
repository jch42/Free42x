...
static const command_spec cmd_array[] =
{
    ...
    { /* CSIZE */       "CSIZE",				5, docmd_csize,       0x0000a442, ARG_NONE,  FLAG_NONE },
    { /* CSIZEO */      "CSIZEO",				6, docmd_csizeo,      0x0000a443, ARG_NONE,  FLAG_NONE },
    { /* DGTIZE */      "DGTIZE",				6, docmd_xrom,        0x0000a444, ARG_NONE,  FLAG_HIDDEN },
    { /* DRAW */      	"DRAW",					4, docmd_draw,        0x0000a445, ARG_NONE,  FLAG_NONE },
    { /* FRAME */       "FRAME",				5, docmd_frame,       0x0000a446, ARG_NONE,  FLAG_NONE },
    { /* GCLEAR */      "GCLEAR",				6, docmd_gclear,      0x0000a447, ARG_NONE,  FLAG_NONE },
